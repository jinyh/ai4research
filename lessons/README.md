...
第 1 课 P03 用具体主张引出效果与范围核查；第 7–8 课分开 Q1 结果、H1 生成机制与 A2 评分解释；第 9–15 课统一使用[可复算构造包](../course/reading-card-case.md)、实际运行标识和权限拒绝记录。板书、诊断反馈与过渡在各课教案。16 课均保持既定 90 分钟结构，四次正式提交、评分和批准课程结构不变。
