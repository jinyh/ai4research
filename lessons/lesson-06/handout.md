...
适用课次：第 6 课
文档类型：学生正式讲义
状态：现行；问题门八项条件、第 3-6 课累计路径、虚构教学案例边界与工件落点已对齐
变更记录：
...
| 第 6 课 | 34-40 分钟核对八项状态；40-60 分钟更新问题定义与第一性原理推导 | 课后只补自查中的缺口，不重做已通过的工件 | 课堂 26 分钟自查与个人实践；课后按缺口而定 | `problem-definition.md` + 上述持续工件 | 课后提交一次问题门材料包 |
...
以下 8 项与 [assignments.md](../../course/assignments.md) Checkpoint 1 门条件一一对应，请逐项自查：
...
| 8 | AI 辅助检索、阅读和问题改写已记录来源与人工核验方式；AI 生成的书目信息、页码、DOI 和引文已回到正式来源核对 | AI 使用记录是否包含用途、Context、输出用途、人工核验方式？AI 生成的书目、页码、DOI 是否已逐项回源核验？ | `ai-usage-log.md` |
...
对照 §五·3 的 8 项门条件逐项自查。确认：候选文献 ≥ 10 篇和精读卡 ≥ 3 张是第 3-5 课“课堂最低产出 + 课间项目推进”的累计结果，不是第 3 或第 4 课当堂自动完成；证据地图初版由第 5 课建立并继续补全；研究问题 + 非例 + 可证伪命题、第一性原理推导和重要性说明由本课回写；AI 使用记录在第 1-6 课持续更新。
...
对照 §五·3 的 8 项门条件，逐项自查当前项目版本。标注已满足、待补全和未满足的条目，并写出未满足条目的修复计划。
