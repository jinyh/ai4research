...
| 文件 | 角色 | 用途 |
| --- | --- | --- |
| [handout.md](./handout.md) | 待定稿·学生讲义 v0.3.0 | 已按 25 人容量和两层展示修订；教师复核前不得视为正式发布版 |
| [teaching-plan.md](./teaching-plan.md) | 现行·教师教案 v0.5.0 | 5+50+25+10=90；全员闪电报告、分组演示与抽查；正式内容门待讲义复核 |
| [slides.md](./slides.md) | 待复核·逐页母稿 v0.5.0（12 页） | 移除长篇理论回顾，围绕两层展示、抽查、复盘与提交；内容门通过前不制作 PPTX |
| [keystone-design-spec.md](./keystone-design-spec.md) | 待复核·关键页设计规格 v1.2.0 | 12 页展示型母稿的页面任务、构图、内容与验收契约；随内容门一起复核 |
| [slides.pptx](./slides.pptx) | 上一版课堂 PPT 候选（20 页） | 与 v0.4.1 已不同步；内容门通过后按 12 页母稿重制 |
