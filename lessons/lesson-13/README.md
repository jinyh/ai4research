...
| 文件 | 角色 | 用途 |
| --- | --- | --- |
| [handout.md](./handout.md) | 现行·学生正式讲义 v0.2.1 | 基于课前已有运行结果完成工作流评价；统一 120 次输出、人工基准限定条件遗漏率、H1/A1/A2/A3 与三态判断；保留验证门 10 项权威条件 |
| [teaching-plan.md](./teaching-plan.md) | 现行·教师教案 v0.3.1 | 整数时长 90 分钟流程、最小成案演示、两段个人实践、中点点评与课后补全边界 |
| [slides.md](./slides.md) | 现行·逐页母稿 v0.5.0（20 页） | 逐页屏显文案、对象化视觉结构、讲述备注、互动、整数时长和来源边界 |
...
| [slides.pptx](./slides.pptx) | 现行·课堂 PPT（20 页） | 已依 v0.5.0 母稿完成对象化视觉提升；保留交大原生 Master/Layout、校徽、红标题带、主题字体、页码和 notes |
