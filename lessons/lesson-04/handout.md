...
*图注：课程自绘结构图。C02、C16、C31 分别承担正向主证据、控制性限制和 patching 效度威胁。图中不含实证数值；来源与许可见 [assets/README.md](./assets/README.md)。*

三张完整卡见 [mi-reading-card-demo.md](./mi-reading-card-demo.md)：
