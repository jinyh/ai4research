...
状态：现行内容母稿；17 页 PPTX 待按本版同步后重新检查
变更记录：
...
| 85-90 分钟 | P17 | 退出卡与第 5 课预告 | 卡点与需求 |
...
| P10 | §四 阅读卡字段 |
| P11 | §六 贯穿案例 第一至二步 |
| P12 | §六 贯穿案例 第三至四步；§二·4 |
| P13 | §六 贯穿案例 第五步；§四 阅读卡 |
| P14 | §七 练习 1-5；§四 |
...
真实原文 + 课堂构造 AI 输出｜非真实模型记录

偏差审计表：

| AI 输出 | 偏差类型 | 原文实际 | 核验位置 | 处理 |
| --- | --- | --- | --- | --- |
| “对照实验证明降低 50%” | 模型新增/伪造效果 | 原文未报告该对照实验 | p.83 摘要与 §2；p.84 §4 | 删除效果主张 |
...
逐条记录课堂构造 AI 输出与真实原文的差异。两行足以展示“伪造效果”和“措辞强化”两种处理，不为凑数量再造一条错误。
...
原文来源同 P11；AI 输出为课堂构造，不对应真实模型运行。
...
- 作者主张：文章提出三遍阅读法 → p.83 §2
- 原文依据：§2.1–§2.3 步骤；p.84 §4 使用经验
- 指标/对照/样本：不适用——未报告受控实验
- 限定：方法建议与经验叙述，非量化效果证据
- AI 建议：待核验，不混入作者主张
- 内容状态：verified-with-caveat（不单独支撑 stable）
...
真实阅读卡字段为主体，下方四问；对“不适用”字段显示理由，不留空占位。

### 教师讲述备注

逐项指出为什么这张卡是“完整”而不是“论文已读完”。完整要求全字段有值或不适用理由，并保留 `verified-with-caveat` 的限定。
...
[reading-card-demo.md](./reading-card-demo.md)；Keshav 2007 真实原文来源同 P11。
