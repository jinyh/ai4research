...
| 文件 | 角色 | 用途 |
| --- | --- | --- |
| [handout.md](./handout.md) | 现行·学生讲义 v0.2.1 | 聚焦一个关键结果的可追溯论证；明确课堂最低产出、课后补全与第 16 课研究门边界；统一虚构案例与 H1/A1/A2/A3 |
| [teaching-plan.md](./teaching-plan.md) | 现行·教师教案 v0.4.1 | 90 分钟减负流程；讲授与演示 30 分钟；两段个人实践均不超过 15 分钟 |
| [slides.md](./slides.md) | 现行·逐页母稿 v0.5.0（16 页） | 以一个结果的回写链为主线；学生屏显不出现课堂计时 |
| [keystone-design-spec.md](./keystone-design-spec.md) | 现行·关键页设计规格 v1.2.0 | 16 页减负母稿的视觉基线、关键页面任务、构图与验收边界 |
| [slides.pptx](./slides.pptx) | 现行·课堂 PPT v0.5.0（16 页） | 对象优先重排；实际标题 30–32 pt、正文 22–24 pt；可编辑对象与 PowerPoint 原生终检通过 |
