...
- 内容、教学与映射：现行讲义、教案和 16 页母稿已同步；90 分钟安排保持原定结构，板书、诊断反馈和过渡见教案。
- PPT：共 16 页；本轮屏显重绘：P03、P04、P05、P06、P07、P08、P09、P10、P11、P12；16/16 页讲述备注及来源已更新。
...
- 文件指纹：`773a0deb25dad14a498adc7a8ef57cfd6f9f99d8a2ed6c88ddffdc4ed5912598`。
...
| [slides.md](./slides.md) | 现行·逐页母稿 v0.6.1 | 16 页屏显、讲述、动作与来源；已同步 PPT |
| [keystone-design-spec.md](./keystone-design-spec.md) | 现行·关键页设计规格 v1.3.1 | 本轮实际构图、可编辑对象与验收；旧规格保留历史 |
| [slides.pptx](./slides.pptx) | 现行·可编辑课堂 PPT（16 页） | 已同步本轮内容；文件与渲染通过，现场核验待完成 |
