...
PUBLISH = {
    ...
    "lessons/lesson-04/reading-card-demo.md": "lessons/lesson-04/reading-card-demo.md",
    "lessons/lesson-04/mi-reading-card-demo.md": "lessons/lesson-04/mi-reading-card-demo.md",
    "lessons/lesson-04/assets/mi-reading-evidence-ladder.svg": "lessons/lesson-04/assets/mi-reading-evidence-ladder.svg",
    "lessons/lesson-05/handout.md": "lessons/lesson-05/handout.md",
    "lessons/lesson-05/mi-evidence-map-demo.md": "lessons/lesson-05/mi-evidence-map-demo.md",
    "lessons/lesson-05/assets/mi-causal-evidence-map.svg": "lessons/lesson-05/assets/mi-causal-evidence-map.svg",
    "lessons/lesson-06/handout.md": "lessons/lesson-06/handout.md",
    "lessons/lesson-06/mi-problem-definition-demo.md": "lessons/lesson-06/mi-problem-definition-demo.md",
    "lessons/lesson-06/assets/mi-question-to-baseline.svg": "lessons/lesson-06/assets/mi-question-to-baseline.svg",
    ...
    "lessons/lesson-09/assets/reproducibility-example/README.md": "lessons/lesson-09/assets/reproducibility-example/README.md",
    "lessons/lesson-09/assets/reproducibility-example/config.json": "lessons/lesson-09/assets/reproducibility-example/config.json",
    "lessons/lesson-09/assets/reproducibility-example/experiment-spec.md": "lessons/lesson-09/assets/reproducibility-example/experiment-spec.md",
    "lessons/lesson-09/assets/reproducibility-example/inputs.json": "lessons/lesson-09/assets/reproducibility-example/inputs.json",
    "lessons/lesson-09/assets/reproducibility-example/results.json": "lessons/lesson-09/assets/reproducibility-example/results.json",
    "lessons/lesson-09/assets/reproducibility-example/run-log.jsonl": "lessons/lesson-09/assets/reproducibility-example/run-log.jsonl",
    "lessons/lesson-09/assets/reproducibility-example/run.py": "lessons/lesson-09/assets/reproducibility-example/run.py",
    "lessons/lesson-10/handout.md": "lessons/lesson-10/handout.md",
    "lessons/lesson-10/assets/agent-task-example/task-01.md": "lessons/lesson-10/assets/agent-task-example/task-01.md",
    "lessons/lesson-10/assets/agent-task-example/failure-log.md": "lessons/lesson-10/assets/agent-task-example/failure-log.md",
    "lessons/lesson-10/assets/agent-task-example/generate.diff": "lessons/lesson-10/assets/agent-task-example/generate.diff",
    "lessons/lesson-10/assets/agent-task-example/test-output.txt": "lessons/lesson-10/assets/agent-task-example/test-output.txt",
    "lessons/lesson-10/assets/agent-task-example/before/generate.py": "lessons/lesson-10/assets/agent-task-example/before/generate.py",
    ...
    "lessons/lesson-13/evaluation-report-example.md": "lessons/lesson-13/evaluation-report-example.md",
