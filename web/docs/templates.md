...
从本课任务进入相应材料；所有记录持续写回同一个个人项目。

## 开始与迁移

- [OpenCode 课前准备](course/opencode-setup.md)：环境确认、权限边界和备用路径。
- [早期研究脚手架](course/starter-template.md)：第 1–8 课维护问题、证据和 AI 使用记录。
- [完整项目模板](course/project-template.md)：第 9 课迁移，保留已有记录。
- [伦理与合规说明模板](course/ethics-and-compliance-template.md)：从第 2 课开始更新。

## 跟着样例做

| 课次 | 模板与完成样例 |
| --- | --- |
| 01 | [两轮提示词、预期 diff 与日志空表](lessons/lesson-01/classroom-pack.md)（课堂构造，含无模型路径） |
| 02 | [风险卡、权限与记录材料包](lessons/lesson-02/classroom-pack.md)（虚构课堂项目，含空表） |
| 03 | [来源审计](lessons/lesson-03/source-audit-demo.md)（真实 Keshav 2007 核验记录） |
...
[逐课阅读清单](course/reading-list.md) · [工具与学习资源](course/resources.md) · [四次提交要求](project.md)

每课通常只安排一项核心阅读，其余按项目需要选读。提交入口与截止时间由教师在课程通知中发布。
