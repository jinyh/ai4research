...
最后更新：2026-09-13
变更记录：
- v2.1.2 (2026-09-13): 同步精简后的阅读清单范围；移除学生资源页中的内部分析入口
...
- 面向 16 次课的实际选读见 [逐课参考阅读清单](./reading-list.md)。经典书籍选章、同行评议论文、共识报告和正式规范构成主干，提供公开入口的系统与教学材料用于案例分析。每课通常只要求 1 项核心阅读，其余按需选读，总数不超过 5 项。
